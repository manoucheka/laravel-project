...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
        ...
        <div id="wrapper">
            <header>
                <section id="top-area">
                    <p>Phone orders: (509)4743-3859 | Email us: <a href="mailto:ingjeanbernard@yahoo.fr">ingjeanbernard@yahoo.fr</a></p>
            ...
            <footer>
                <section id="contact">
                    <h3>For phone orders please call (509)4743-3859. You<br>can also email us at <a href="mailto:ingjeanbernard@yahoo.fr">ingjeanbernard@yahoo.fr</a></h3>
                </section><!-- end contact -->
                ...
                <section class="clearfix">
                    <div id="copyright">
                        ...
                        <p id="store-copy">&copy; 2014 eCommerce. Theme designed by Jean Bernard Marcellus.</p>
                    </div><!-- end copyright -->
                    <div id="connect">
